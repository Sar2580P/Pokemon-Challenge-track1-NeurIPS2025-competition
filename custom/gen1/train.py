...
app, img= get_modal_stuff(app_name="Metamon_training_gen1")
volume = modal.Volume.from_name("pokemon-showdown-gen1", create_if_missing=True)
...
# if __name__ == "__main__":      
    ...
    amago_dataset = create_offline_dataset(
        ...
        action_space=action_space,
        reward_function=reward_function,
        parsed_replay_dir=osp(os.environ["METAMON_CACHE_DIR"], args.parsed_replay_dir) if args.parsed_replay_dir else None,
        custom_replay_dir=osp(os.environ["METAMON_CACHE_DIR"], args.custom_replay_dir) if args.custom_replay_dir else None,
