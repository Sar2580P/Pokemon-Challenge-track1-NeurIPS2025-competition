...
PYTHON_SCRIPT="custom/gen1/train_opponent_modeling.py"

# --- Set your required arguments here ---
# These arguments are required by the Python script
RUN_NAME="HRM-Gen-1-OpponentModeling"
SAVE_DIRECTORY="results"
PARSED_REPLAY_DIR="parsed-replays" 
MODEL_CONFIG="./custom/gen1/configs/opponent_modeling_hrm_agent.gin"
TRAIN_CONFIG="./custom/gen1/configs/opponent_modeling_train.gin"
FORMATS="gen1ou"
